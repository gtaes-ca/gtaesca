...
function hasContactSectionImage(image) {
    const value = String(image || '').trim()
    if (!value) return false
    if (value === 'assets/images/backgrounds/video-one-bg.jpg') return false
    return true
}
...
export default function AboutContact() {
    ...
    const backgroundImage = hasContactSectionImage(content.backgroundImage)
        ? resolveCmsAssetUrl(content.backgroundImage)
        : ''

    return (
        <section className="video-one about-contact">
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-xl-6">
                        {backgroundImage ? (
                            <div
                                className="about-contact__image-wrap wow slideInLeft"
