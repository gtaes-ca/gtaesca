...
const HomeAboutForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm(mapAboutFromApi(res.data.content || {}));
      showNotification({ message: 'Homepage about section saved', variant: 'success' });
    } catch (err) {
      showNotification({
      ...
      {loading ? (
        ...
        <form onSubmit={handleSubmit}>
          <Row className="g-4">
            ...
            <Col xs={12}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  placeholder="Trusted Electrical Experts Across the Greater Toronto Area"
                  required
                />
              </Form.Group>
            </Col>
            ...
            <Col md={6}>
              <Form.Group>
                <Form.Label>Certified Badge — Line 1</Form.Label>
                <Form.Control
                  value={form.badgeLine1}
                  onChange={(e) => updateField('badgeLine1', e.target.value)}
            ...
            <Col md={6}>
              <Form.Group>
                <Form.Label>Certified Badge — Line 2</Form.Label>
                <Form.Control
                  value={form.badgeLine2}
                  onChange={(e) => updateField('badgeLine2', e.target.value)}
                  placeholder="company since 1997"
                />
              </Form.Group>
            </Col>
            ...
            <Col xs={12}>
              <h6 className="mb-2">Side Images</h6>
            </Col>

            <Col md={6}>
              <ImagePreview label="Primary side image" imageUrl={form.image1Preview} />
              <Form.Text className="d-block mb-2 text-muted">
                Left column image (recommended portrait 4:5)
              </Form.Text>
              <Form.Control
                type="file"
            ...
            <Col md={6}>
              ...
              <Form.Text className="d-block mb-2 text-muted">
                Right column image below the certified badge
              </Form.Text>
              <Form.Control
                type="file"
                accept="image/jpeg,image/png,image/webp,image/gif"
